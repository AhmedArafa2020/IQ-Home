...
// ************************************ FRONT SECTION **********************************************
    ...
    Route::get('/newcontact', 'Front\FrontendController@newcontact')->name('front.newcontact');
    Route::get('/newabout', 'Front\FrontendController@newabout')->name('front.newabout');
